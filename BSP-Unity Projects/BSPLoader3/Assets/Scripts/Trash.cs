...
//		}
//	}
    //UnityEngine.Plane[] SortPlanes_bad(UnityEngine.Plane[] planes)
    //{
    //    Vector3[] points = new Vector3[planes.Length];
    //    for (int i = 0; i < points.Length; i++)
    //    {
    //        points[i] = GetOnePointOnPlane(planes[i]);
    //    }
    //    //for (int i = 0; i < points.Length; i++)
    //    //{
    //    //    Debug.Log(points[i]);
    //    //}
    //    // insert-sort points in x-axis
